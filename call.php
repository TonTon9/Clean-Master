			...
			<div class="container">
				<div class="call__body">
					...
					<form action="" method="POST">
						...
						<input type="hidden" name="admin_email" value="masterclean.bratislava@gmail.com">
...
<!-- <form action="" method="POST">
										<input type="hidden" name="project_name" value="Мойка">
										<input type="hidden" name="admin_email" value="max.schadrin.2002@yandex.ru">
										<input type="hidden" name="form_subject" value="тестовая отправка">
										<input name="JOKE" type="email" required placeholder="Ваш E-MAIL" name="mail">										
